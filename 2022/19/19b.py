...
for i, bluePrint in enumerate(bluePrints[:3]):
    ...
    maxPerPhase = [0 for i in range(32)]
    skipped = [0,0,0,0]
    maxScore = 0
    pathsCompleted = 0
    scenarios = {}
